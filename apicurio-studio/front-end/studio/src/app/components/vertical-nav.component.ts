...
export class VerticalNavComponent implements OnInit {
    ...
    /**
     * Returns true if the currently active route is /development/*
     * @returns {boolean}
     */
    ...
    /**
     * Returns true if the currently active route is /test/*
     * @returns {boolean}
     */
    isTestRoute(): boolean {
        return this.isRouteActive("/test");
    }

    /**
     * Returns true if the currently active route is /devOps/*
     * @returns {boolean}
     */
    isDevOpsRoute(): boolean {
        return this.isRouteActive("/devOps");
    }

    /**
     * Returns true if the currently active route is /operations/*
     * @returns {boolean}
     */
    isOperationsRoute(): boolean {
        return this.isRouteActive("/operations");
    }
}
